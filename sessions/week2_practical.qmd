...
df.loc[:, 'TOTPUPS'] = pd.to_numeric(df['TOTPUPS'], errors='coerce').astype('Int64')
```
...
*Note* this is no longer a histogram - rather we're starting to explore the relationship between different random variables!
